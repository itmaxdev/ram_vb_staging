<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="verifier.aspx.vb" Inherits="Ram.cd.Services_Verify_IMEI" %>
...
<head runat="server">
    ...
    <!-- Bootstrap css -->
    <link href="bootstrap/boostrap/css/bootstrap.min.css" rel="stylesheet" />
    <!-- Bootstrap jQuery -->
...
#transactionlist {display: none !important;
}
/*  ul {
    ...
    <script type="text/javascript">
        function nothuman(s) {
            ...
            if (response.length == 0) {
                ...
                var msisdn = "";
                if (msis.value != "") {
                    msis.value = msis.value.replace(/^0+/, '');
                    msisdn = tcode.replace('+', '') + msis.value;
                }
                var result = PageMethods.VerifyIMEI(imri.value, msisdn,  <%=LanguageID%>, function (response) {
                    var check = response.split(" ")[0];

                    if (check == "swal") {
                        swal(response.substr(response.indexOf(" ") + 1));
                    } else {
                        if (response === "") {
                            swal("Something Went Wrong");
                        } else {
                            ssdegg_top1.style.display = "none";
        ...
        function showtab(s, tt) {
            var outputres = document.getElementById(s);

            var outputDeviceInfo = document.getElementById('DeviceInfo');
            var outputRamInfo = document.getElementById('RamInfo');
            var outputPaymentInfo = document.getElementById('PaymentInfo');
            var transactionlist = document.getElementById('transactionlist');

            var tb1 = document.getElementById('tbDevice');
            var tb2 = document.getElementById('tbRam');
            var tb3 = document.getElementById('tbPay');

            tb1.className = 'TabUnselected';
            tb2.className = 'TabUnselected';
            tb3.className = 'TabUnselected';

            tt.className = 'tabSelected';
            ...
            outputDeviceInfo.style.display = "none";
            outputDeviceInfo.style.visibility = "hidden";

            outputRamInfo.style.display = "none";
            outputRamInfo.style.visibility = "hidden";

            outputPaymentInfo.style.display = "none";
            outputPaymentInfo.style.visibility = "hidden";

            outputres.style.display = "";
...
<body>
    <form id="form1" runat="server">
            ...
            <div class="container-full">
                <div class="row no-gutters">
                    <div class="col-md-3 col-lg-2" style="padding-right: 0px;">
                        ...
                        <%--<div class="vry-left">
                            <a href="verifier.aspx">
                                <div class="vry-a1">
                                    <img src="img/VerifyIMEI_Selected.png" alt="images not found" />
                    ...
                    <div class="col-md-9 col-lg-10" style="padding-left: 0px;">
                        <div class="vry-right">
                            <div class="vry-b1 vry-d1" style="min-height: 207px !important">
                                <p><%=GetContent("Services_Verify_IMEI_Hello") %>&nbsp;</p>
                                <div class="row no-gutters">
                                    <div class="col-lg-6 col-md-3">
                                        <span>
                                            <input class="forminput" type="number" max="999999999999999" min="10000000000000" name="txtIMEI" id="txtIMEI" placeholder="<%=GetContent("IMEI Number") %>" autofocus="autofocus" /></span>
                                    </div>
                                    <div class="col-lg-6 col-md-5" >
                                        <select style="padding-left: 2px; padding-right: 0; height:80% !important; width: 30%;  <%=IIf(LanguageID = 2, "visibility:hidden;display:none;", "") %>" class="forminput" id="countryCode<%=IIf(LanguageID = 2, "NotUsed", "") %>" name="countryCode<%=IIf(LanguageID = 2, "NotUsed", "") %>">
                                        ...
                                        <select style="width: 30%; padding-left: 2px; padding-right: 0; <%=IIf(LanguageID = 1, "visibility:hidden;display:none;", "") %>" class="forminput" id="countryCode<%=IIf(LanguageID = 1, "NotUsed", "") %>" name="countryCode<%=IIf(LanguageID = 1, "NotUsed", "") %>">
                                        ...
                                        <input style="width: 66.5%;" class="forminput" type="number" min="0" value="" name="txtPhone" id="txtPhone" placeholder="<%=GetContent("Phone Number") %>" />
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        <div class="px-contact-input" align="right" style="padding-right: 8px">
                                            <button class="submit forminputbutton g-recaptcha" data-sitekey="6Lf0U8MaAAAAAE4gubHH3oeaG1rBa7Hrl8bcS3au" data-callback='onSubmit' data-action='submit' type="button" onclick="return nothuman(this);" align="right" runat="server" id="btnBlock">
                                                <i class="fa fa-angle-right"></i><%=GetContent("VerifyButton") %>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- degg_top-area end -->
                            <asp:Literal ID="tableResults" runat="server" />
                            <div style="margin-top: 4.3rem;">
                                <div class="" id="results" name="results">
                                </div>
                            </div> 
                            <div class="container">
                                    <div class="">
                                        <div class="row">
                                            <div class="col-md-12 col-lg-12">
                                                <div class=" ">
                                                    <span class="degg_top1 " style="margin-bottom: 0.5rem;" id="ssdegg_top1"></span>
                                                    <p style="padding-bottom: 2px; margin-bottom: 0.5rem; font-size: 14px;">
                                                        <%=GetContent("Services_Verify_IMEI_PageIntro") %>
                                                    </p>
                    ...
                    <!-- degg-area start -->
                            <div class="degg-area resizers">
                                <div class="container">
                                    <div class="degg-top">
                                        <h2><%=GetContent("Services_Verify_IMEI_3SimpleSteps") %></h2>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4">
                                            <div class="deg-part_a1 justify-content-center" style="margin-left:-30px">
                                                <h2>01</h2>
                                                <span class="drg_spn"></span>
                                                <p>
                                                    <%=GetContent("Services_Verify_IMEI_3SimpleSteps_Step1Heading") %>
                                                </p>
                                                <p style="min-height: 225px;">
                                                    <img src="img/sr2.png" alt="images not found" />
                                                </p>
                                                <span class="drg_spns"></span>
                                                <h5 style="font-size: 10px; text-align: center"><%=GetContent("Services_Verify_IMEI_3SimpleSteps_Step1Description") %></h5>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="deg-part_a1 justify-content-center">
                                                ...
                                                <span class="drg_spn"></span>
                                                <p>
                                                    <%=GetContent("Services_Verify_IMEI_3SimpleSteps_Step2Heading") %>
                                                </p>
                                                <p style="min-height: 218px; max-height: 225px">
                                                    <img src="img/sr3.png" alt="images not found" style="margin-left: -85px;" />
                                                </p>
                                                <span class="drg_spns"></span>
                                                <h5 style="font-size: 10px; text-align: center"><%=GetContent("Services_Verify_IMEI_3SimpleSteps_Step2Description") %></h5>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="deg-part_a1 justify-content-center">
                                                ...
                                                <span class="drg_spn"></span>
                                                <p>
                                                    <%=GetContent("Services_Verify_IMEI_3SimpleSteps_Step3Heading") %>
                                                </p>
                                                <p style="min-height: 225px;">
                                                    <img src="img/sr4.png" alt="images not found" style="margin-left: -65px;" />
                                                </p>
                                                <span class="drg_spns"></span>
                                                <h5 style="font-size: 10px; text-align: center"><%=GetContent("Services_Verify_IMEI_3SimpleSteps_Step3Description") %></h5>
                                            </div>
                                        </div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-12">
                                            <div class="wci-left">
                                                <span class="wci_spn"></span>
                                                <h2><%=GetContent("Services_Verify_IMEI_WhatCanICheck") %></h2>
                                                <%=GetContent("Services_Verify_IMEI_WhatCanICheckDetail") %>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-12">
                                            <div class="wci-right" style="border: 2px solid #1e5db8 !important;">
                                                <a href="#myModal" class="" data-toggle="modal">
                                                    <img src="img/Youtube-bg-1.jpg" class="img-responsive" /></a>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="embed-responsive embed-responsive-16by9">
                                                                    <iframe security="restricted" id="cartoonVideo" class="embed-responsive-item" width="100%" height="350" src="https://www.youtube.com/embed/kx3tVArOHNs" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                                ...
                                                <%--<iframe width="100%" height="350" src="https://www.youtube.com/embed/kx3tVArOHNs" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>--%>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <script>
            ...
            //        "ordering": false
            //    }).buttons().container().appendTo('#PaymentInfo');
            //});
