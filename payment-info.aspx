<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="payment-info.aspx.vb" Inherits="Ram.cd.payment_info" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        @media screen and (min-width: 10px) and (max-width: 367px) {
            .mresult {
                zoom: 0.78;
            }
        }
    ...
    <script type="text/javascript">
        function nothuman(s) {
            ...
            if (response.length == 0) {
                ...
                var result = PageMethods.GetPaymentInfo(msis.value,  <%=LanguageID%>, tcode.replace('+', ''), function (response) {
        ...
        <div class="vry-area">
            <div class="container-full">
                <div class="row no-gutters">
                    ...
                    <div class="col-md-9 col-lg-10" id="scrollBench" style="padding-left: 0px;">
                        <div class="vry-right">
                            <div class="vry-b1 vry-d1" style="min-height: 207px !important">
                                <p><%=GetContent("Payment_Info_Hello") %>&nbsp;</p>
                                <div class="row no-gutters">
                                    <div class="col-lg-6 col-md-3">
                                        <span>
                                            <input class="forminput" style="display: none;" type="number" name="txtIMEI" id="txtIMEI" placeholder="<%=GetContent("IMEI Number") %>" autofocus="autofocus" max="9" /></span>
                                    </div>
                                    <div class="col-lg-6 col-md-5">
                                        <select style="padding-left: 2px; padding-right: 0; width: 30%; <%=IIf(LanguageID = 2, "visibility:hidden;display:none;", "") %>" class="forminput" class="input-block-level" id="countryCode<%=IIf(LanguageID = 2, "NotUsed", "") %>" name="countryCode<%=IIf(LanguageID = 2, "NotUsed", "") %>">
                                        ...
                                        <select style="width: 30%; padding-left: 2px; padding-right: 0; <%=IIf(LanguageID = 1, "visibility:hidden;display:none;", "") %>" class="forminput" class="input-block-level" id="countryCode<%=IIf(LanguageID = 1, "NotUsed", "") %>" name="countryCode<%=IIf(LanguageID = 1, "NotUsed", "") %>">
                                        ...
                                        <input style="width: 68%;" class="forminput" type="number"  min="0" value="" name="txtPhone"  id="txtPhone" placeholder="<%=GetContent("Phone Number") %>" />
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        <div class="px-contact-input" align="right" style="padding-right: 8px">
                                            ...
                                            <button class="submit forminputbutton g-recaptcha" data-sitekey="6Lf0U8MaAAAAAE4gubHH3oeaG1rBa7Hrl8bcS3au" data-callback='onSubmit' data-action='submit' type="button" onclick="return nothuman(this);" align="right" runat="server" id="btnBlock">
                                                <i class="fa fa-angle-right"></i><%=GetContent("SubmitButton").ToUpper() %>
                                            </button>
                        ...
                        <div class="degg_top-area">
                            <div class="container mresult" id="results" name="results">
                            </div>
                            <br />
                        </div>
                        <div class="degg_top-area">
                                ...
                                <div class="degg_top_b1">
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12">
                                            <div class="degg_top">
                                                <span class="degg_top1" id="ssdegg_top1"></span>
                                                <p>
                                                    <%=GetContent("Services_Payment_Info_PageIntro") %>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4">
                                            <div class="deg-part_a1 justify-content-center">
                                                ...
                                                <p style="min-height: 225px;">
                                                    <img src="img/sr2.png" alt="images not found" /></p>
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <div class="deg-part_a1 justify-content-center">
                                                ...
                                                <p style="min-height: 218px; max-height: 225px">
                                                    <img src="img/sr3.png" alt="images not found" /></p>
                                                <span class="drg_spns"></span>
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <div class="deg-part_a1 justify-content-center">
                                                ...
                                                <p style="min-height: 225px;">
                                                    <img src="img/sr4.png" alt="images not found" /></p>
                                                <span class="drg_spns"></span>
