<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="News.aspx.vb" Inherits="Ram.cd.News" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function CloseIframe() {
            var hh = cartoonVideo.src;
            cartoonVideo.src = 'about:blank';
            sleep(1250);
            cartoonVideo.src = hh;
        }
...
<body>
    <form id="form1" runat="server">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <div class="main-menu-part">
                                    <ul>
                                        ...
                                        <li><a href="/News.aspx?Language=2">FR</a></li>
                                        <li><a href="/News.aspx?Language=1">EN</a></li>
                                    </ul>
                                </div>
                            </div>
                        </nav>
        ...
        <!-- svo-area end -->
        <!--===== start feature-news area =====-->
        <section class="feature-news-area">
            <div class="container">
        ...
        <!--===== completed feature-news area =====-->
        <!--===== start news-links area =====-->
        <section class="news-links-area">
            <div class="container">
                <div class="row">
			<%=LoadNews() %>
              </div>
...
<script>$( document ).ready(function() {
    $('.wci-right').html('<iframe width="100%" height="100%" src="https://www.youtube.com/embed/Z4T8Wwnog6s?color=light" frameborder="0" allowfullscreen=""></iframe>');
});</script>
    </form>
</body>
</html>
