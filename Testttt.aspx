<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Testttt.aspx.vb" Inherits="Ram.cd.Testttt" %>
...
<body>
    ...
    <table id="tableID" class="display" style="width:100%; background-color:white">
        <thead>
            <tr>
                <td>StudentID</td>
                <td>StudentName</td>
